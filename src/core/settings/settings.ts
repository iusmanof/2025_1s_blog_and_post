...
export const SETTINGS = {
    ...
    DB_COLLECTION_SECURITY_LIMIT: process.env.DB_COLLECTION_SECURITY_LIMIT as string || 'security_limit',
    DB_COLLECTION_SECURITY_DEVICES: process.env.DB_COLLECTION_SECURITY_DEVICES as string || 'security_devices',
