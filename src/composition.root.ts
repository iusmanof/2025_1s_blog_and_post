...
import {SecurityDevicesQueryRepository} from "./auth/repository/security-devices.query-repository";
...
export const securityDevicesService = new SecurityDevicesService(jwtAdapter, securityDevicesRepository, securityDevicesQueryRepository);
export const authService = new AuthService(jwtAdapter, emailAdapter, bcryptAdapter, securityDevicesService, securityDevicesQueryRepository, securityDevicesRepository, usersQueryRepository,usersRepository, );
