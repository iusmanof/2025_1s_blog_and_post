...
import {SecurityDeviceDbDto, UPDATEsecurityDeviceDbDto} from "../types/security-device-db.dto";
...
export const securityDevicesRepository = {
    ...
    async updateDevice(deviceId: string, updatedDbDto: UPDATEsecurityDeviceDbDto) {
    ...
    async deleteAllDevicesExcludeCurrent(deviceId: string) {
        await getSecurityDeviceCollection().deleteMany({deviceId: { $ne: deviceId }})
    }
