...
const BlogHandler = {
    GET_BLOG_ID_POSTS: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!errors.isEmpty()) {
            res.status(http_status_code_1.default.NOT_FOUND_404).json({ errors: errors.array() });
            return;
        }
        ...
        if (!posts) {
            res.status(http_status_code_1.default.NOT_FOUND_404).send("Posts not found.");
            return;
        }
    ...
    POST_BLOG_ID_POSTS: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        res.status(http_status_code_1.default.CREATED_201).json(blogCreated);
    }),
};
