...
let BlogController = class BlogController {
  constructor(blogService, postService) {
    ...
    this.update = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const blogIsUpdated = yield this.blogService.update(
          req.params.id,
          req.body,
        );
        const apiErrorMsg = [];
    ...
    this.create = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        return yield res
          .status(http_status_code_1.default.CREATED_201)
          .json(blogCreated);
      });
    this.createPostByBlogId = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const blogCreated = yield this.blogService.createPostByBlogId(
          req.body,
          req.params.blogId,
        );
        res.status(http_status_code_2.default.CREATED_201).json(blogCreated);
      });
    this.findPostsByBlogId = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const errors = (0, express_validator_1.validationResult)(req);
        if (!errors.isEmpty()) {
          res
        ...
        const posts = yield this.postService.findPostsByBlogId(
          blogId,
          req.query,
        );
        if (!posts) {
