  ...
  constructor(usersService, usersQueryRepository) {
    ...
    this.findAllUsers = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const {
          ...
          searchLoginTerm,
          searchEmailTerm,
        } = (0, sort_query_default_util_1.sortQueryFieldsUtil)(query);
        // TODO controller dont work with queryRepository
        const users = yield this.usersQueryRepository.findAllUsers({
          pageNumber,
          pageSize,
          sortBy,
          sortDirection,
    ...
    this.createUser = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const userId = yield this.usersService.create({
          login,
          password,
          email,
        });
    ...
    this.delete = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        return res
          .status(http_status_code_2.default.NO_CONTENT_204)
          .send("Deleted");
      });
  }
};
