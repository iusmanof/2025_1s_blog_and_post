...
const http_status_code_2 = __importDefault(
  require("../../core/types/http-status-code"),
);
const result_object_1 = require("../../core/types/result-object");
const comments_service_1 = __importDefault(
  require("../../comments/services/comments.service"),
);
const http_status_code_3 = __importDefault(
  require("../../core/types/http-status-code"),
);
...
let PostController = class PostController {
  constructor(postService, commentsService, jwtAdapter) {
    ...
    this.update = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const postIsUpdated = yield this.postService.update(
          req.params.id,
          req.body,
        );
        const apiErrorMsg = [];
    ...
    this.createComment = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield this.commentsService.create(
          userId,
          postId,
          content,
        );
    ...
    this.getComments = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield this.commentsService.getCommentByPostId(
          postId,
          query,
          userId,
        );
