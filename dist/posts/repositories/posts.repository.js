...
let PostsRepository = class PostsRepository {
  ...
  getPostById(id) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return Object.assign(Object.assign({}, result.toObject()), {
  ...
  createPost(post) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const _a = postDocument.toObject(),
        { _id, __v } = _a,
        rest = __rest(_a, ["_id", "__v"]);
  ...
  updatePost(id, post) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const isUpdated = yield post_entity_1.PostModel.updateOne(
        { _id: new mongodb_1.ObjectId(id) },
        {
          $set: updateFields,
        },
