...
class PostsRepository {
    ...
    getPostById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield (0, mongo_db_1.getPostCollection)().findOne({ _id: new mongodb_1.ObjectId(id) });
            if (!result) {
                return null;
            }
    ...
    createPost(post) {
        return __awaiter(this, void 0, void 0, function* () {
            const blog = yield composition_root_1.blogsRepository.getBlogById(post.blogId);
            const postCreated = {
                title: post.title,
    ...
    updatePost(id, post) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isUpdated = yield (0, mongo_db_1.getPostCollection)().updateOne({ _id: new mongodb_1.ObjectId(id) }, {
                $set: updateFields,
            });
