...
exports.postRouter.post("/:postId/comments", access_token_guard_1.accessTokenGuard, comments_validation_middleware_1.commentValidationa, input_validation_middleware_1.inputValidationMiddleware, post_id_validation_middleware_1.postIdValidationMiddleware, user_id_validation_middleware_1.userIdValidationMiddleware, create_comment_handler_1.createCommentHandler);
exports.postRouter.get("/:postId/comments", (0, query_pagination_sorting_validation_middleware_1.paginationAndSortingValidation)(), get_comment_handler_1.getCommentsByPostIdHandler);
