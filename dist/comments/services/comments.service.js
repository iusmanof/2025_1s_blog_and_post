...
let CommentsService = class CommentsService {
  ...
  create(userId, postId, content) {
    return __awaiter(this, void 0, void 0, function* () {
      const newComment = yield this.commentsRepository.create(
        userId,
        postId,
        content,
      );
      ...
      const resultComment = Object.assign(Object.assign({}, newComment), {
        likesInfo: Object.assign(Object.assign({}, newComment.likesInfo), {
          myStatus: myStatus,
        }),
      });
      return {
  ...
  getCommentByPostId(postId, query, userId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const commentsPage = yield this.commentsRepository.getCommentsByPostId(
        postId,
        query,
      );
      if (!commentsPage) {
      ...
      const itemsWithStatus = yield Promise.all(
        commentsPage.items.map((comment) =>
          __awaiter(this, void 0, void 0, function* () {
            let myStatus = like_1.LikeStatus.None;
            if (userId) {
              const statusCurrentUser =
                yield this.commentsRepository.getStatusByUserId(
                  comment.id,
                  userId,
                );
              if (statusCurrentUser && statusCurrentUser.status) {
                myStatus = like_1.LikeStatus[statusCurrentUser.status];
              }
            }
            return Object.assign(Object.assign({}, comment), {
              likesInfo: Object.assign(Object.assign({}, comment.likesInfo), {
                myStatus,
              }),
            });
          }),
  ...
  getByCommentId(commentId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const commentWithStatus = Object.assign(Object.assign({}, comment), {
        likesInfo: Object.assign(Object.assign({}, comment.likesInfo), {
          myStatus,
        }),
      });
  ...
  updateById(commentId, content) {
    return __awaiter(this, void 0, void 0, function* () {
      const result = yield this.commentsRepository.updateById(
        commentId,
        content,
      );
      if (!result) {
  ...
  setLikeStatus(commentId, newLikeStatusString, userId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.commentsRepository.updateStatusByUserId(
        commentId,
        userId,
        finalStatus,
      );
      yield this.commentsRepository.setCommentLikeStatus(
        comment.id,
        likesCount,
        dislikesCount,
      );
...
CommentsService = __decorate(
  [
    ...
    __param(
      0,
      (0, inversify_1.inject)(comments_repository_1.CommentsRepository),
    ),
