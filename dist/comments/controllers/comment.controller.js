...
const comments_service_1 = __importDefault(
  ...
  constructor(commentsService, jwtAdapter) {
    ...
    this.getByCommentId = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield this.commentsService.getByCommentId(
          commentId,
          userId,
        );
    ...
    this.deleteById = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        //getCommentById
        const comment = yield this.commentsService.getByCommentId(
          commentId,
          userId,
        );
    ...
    this.updateById = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield this.commentsService.updateById(
          commentId,
          content,
        );
        if (result.status === result_object_1.resultStatus.ERROR) {
    ...
    this.setLikeStatus = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const commentId = req.params.id;
        const likeStatus = req.body.likeStatus;
        const userId = req.user.id;
        const result = yield this.commentsService.setLikeStatus(
          commentId,
          likeStatus,
          userId,
        );
        if (result.status === result_object_1.resultStatus.ERROR) {
          res
            ...
            .send("Comment is invalid");
          return;
        }
        if (result.status === result_object_1.resultStatus.NOT_FOUND) {
          res
            .status(http_status_code_1.default.NOT_FOUND_404)
            .send("Comment not founded");
          return;
        }
        if (result.status === result_object_1.resultStatus.SUCCESS) {
          res
            .status(http_status_code_1.default.NO_CONTENT_204)
            .send("Update like status");
          return;
        }
      });
  }
