...
let CommentsRepository = class CommentsRepository {
  ...
  getCommentsByPostId(postId, query) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const totalCount = (yield comments_entiry_1.CommentMongooseModel.find(
        search,
      ).exec()).length;
      return {
  ...
  updateById(commentId, content) {
    return __awaiter(this, void 0, void 0, function* () {
      const result = yield comments_entiry_1.CommentMongooseModel.updateOne(
        { _id: new mongodb_1.ObjectId(commentId) },
        { $set: { content: content } },
      );
  ...
  setCommentLikeStatus(id, likeCount, dislikeCount) {
    return __awaiter(this, void 0, void 0, function* () {
      return comments_entiry_1.CommentMongooseModel.updateOne(
  ...
  getStatusByUserId(commentId, userId) {
    return __awaiter(this, void 0, void 0, function* () {
      return comments_entiry_1.CommentReactionModel.findOne({
        userId,
        commentId,
      }).lean();
    });
  ...
  updateStatusByUserId(commentId, userId, finalStatus) {
    return __awaiter(this, void 0, void 0, function* () {
      yield comments_entiry_1.CommentReactionModel.updateOne(
        { userId, commentId },
        { status: finalStatus },
        { upsert: true },
      );
