...
const PostHandler = {
    GET: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const result = yield post_data_access_layer_mongodb_1.postDataAccessLayerMongoDB.getAllPosts();
        return res.status(HttpStatusCode_1.default.OK_200).send(result);
    }),
    GET_ID: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const postFounded = yield post_data_access_layer_mongodb_1.postDataAccessLayerMongoDB.getPostById(req.params.id);
        if (!postFounded)
    ...
    POST: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const postCreated = yield post_data_access_layer_mongodb_1.postDataAccessLayerMongoDB.createPost(req.body);
        const apiErrorMsg = [];
        if (!postCreated) {
    ...
    PUT: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const postIsUpdated = yield post_data_access_layer_mongodb_1.postDataAccessLayerMongoDB.updatePost(req.params.id, req.body);
        const apiErrorMsg = [];
        if (!postIsUpdated) {
            apiErrorMsg.push({ message: "ID Not found", field: "id" });
            return yield res
    ...
    DELETE: (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const post = yield post_data_access_layer_mongodb_1.postDataAccessLayerMongoDB.deletePost(req.params.id);
        if (!post)
