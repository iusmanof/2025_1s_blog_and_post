...
const authRepository = composition_root_1.container.get(
  auth_repository_1.AuthRepository,
);
const blogsRepository = composition_root_1.container.get(
  blogs_repository_1.BlogsRepository,
);
const commentsRepository = composition_root_1.container.get(
  comments_repository_1.CommentsRepository,
);
const postsRepository = composition_root_1.container.get(
  posts_repository_1.PostsRepository,
);
const securityDevicesRepository = composition_root_1.container.get(
