...
const runDB = (url) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      listRefreshTokenCollection = db.collection(
        settings_1.SETTINGS.DB_COLLECTION_LIST_REFRESH_TOKEN,
      );
      commentCollection = db.collection(
        settings_1.SETTINGS.DB_COLLECTION_COMMENTS,
      );
      securityDevicesCollection = db.collection(
        settings_1.SETTINGS.DB_COLLECTION_SECURITY_DEVICES,
      );
