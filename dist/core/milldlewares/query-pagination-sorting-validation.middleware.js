...
function paginationAndSortingValidation() {
    return [
        (0, express_validator_1.query)("sortBy").optional().default(DEFAULT_SORT_BY).isString().trim(),
        (0, express_validator_1.query)("sortDirection")
            .optional()
            .default(DEFAULT_SORT_DIRECTION)
            .isString()
            .trim(),
        (0, express_validator_1.query)("pageNumber").optional().default(DEFAULT_PAGE_NUMBER).isNumeric(),
        (0, express_validator_1.query)("pageSize").optional().default(DEFAULT_PAGE_SIZE).isNumeric(),
    ];
}
