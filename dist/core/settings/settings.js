...
exports.SETTINGS = {
    ...
    DB_COLLECTION_SECURITY_LIMIT: process.env.DB_COLLECTION_SECURITY_LIMIT || 'security_limit',
    DB_COLLECTION_SECURITY_DEVICES: process.env.DB_COLLECTION_SECURITY_DEVICES || 'security_devices',
