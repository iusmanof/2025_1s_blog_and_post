...
exports.securityDevicesRepository = {
  findAllDevices() {
    return __awaiter(this, void 0, void 0, function* () {
      return (0, mongo_db_1.getSecurityDeviceDb)().find().toArray();
    });
  },
  addDevice(dbDto) {
    return __awaiter(this, void 0, void 0, function* () {
      yield (0, mongo_db_1.getSecurityDeviceDb)().insertOne(dbDto);
    });
  },
  deleteAllDevices() {
    return __awaiter(this, void 0, void 0, function* () {
      return (0, mongo_db_1.getSecurityDeviceDb)().deleteMany({});
    });
  },
};
