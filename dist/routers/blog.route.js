...
exports.BlogRouter.get(
  "/",
  (0, blogsQueryValidation_1.paginationAndSortingValidationWithSearchName)(),
  BlogHandler_1.default.GET,
);
exports.BlogRouter.get("/:id", BlogHandler_1.default.GET_ID);
exports.BlogRouter.get(
  "/:blogId/posts",
  (0, blogsQueryValidation_1.paginationAndSortingValidation)(),
  BlogHandler_1.default.GET_BLOG_ID_POSTS,
);
exports.BlogRouter.post(
  "/",
  super_admin_guard_middleware_1.basicAuth,
  [nameValidation_1.nameValidation, websiteValidation_1.websiteValidation],
  input_validation_middleware_1.inputValidationMiddleware,
  BlogHandler_1.default.POST,
);
exports.BlogRouter.post(
  "/:blogId/posts",
  super_admin_guard_middleware_1.basicAuth,
  [
    titleValidation_1.titleValidation,
    contentValidation_1.contentValidation,
    shortDescriptionValidation_1.shortDescriptionValidation,
  ],
  input_validation_middleware_1.inputValidationMiddleware,
  BlogHandler_1.default.POST_BLOG_ID_POSTS,
);
exports.BlogRouter.put(
  ...
  [nameValidation_1.nameValidation, websiteValidation_1.websiteValidation],
  input_validation_middleware_1.inputValidationMiddleware,
  BlogHandler_1.default.PUT,
);
exports.BlogRouter.delete(
  "/:id",
  super_admin_guard_middleware_1.basicAuth,
  BlogHandler_1.default.DELETE,
);
