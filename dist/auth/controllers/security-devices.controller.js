  ...
  constructor(securityDevicesService) {
    ...
    this.getAllDevices = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const devices =
          yield this.securityDevicesService.getDevices(refreshToken);
        if (!devices) {
          res
    ...
    this.deleteAllSessionExcludeCurrent = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const refreshToken = req.cookies.refreshToken;
        yield this.securityDevicesService.terminateAllSessionExcludeCurrent(
          refreshToken,
        );
        res
