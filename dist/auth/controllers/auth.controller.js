...
let AuthController = class AuthController {
  constructor(authService) {
      ...
      __awaiter(this, void 0, void 0, function* () {
        ...
        const ipAddr = req.headers["x-forwarded-for"]
          ...
          : req.headers["x-forwarded-for"] ||
            ...
            "unknown ip";
        const userAgent =
          (_a = req.headers["user-agent"]) !== null && _a !== void 0
            ? _a
            : "userAgent undefined";
        ...
        if (
          result.status === result_object_1.resultStatus.ERROR ||
          result.data === null
        ) {
          return res
    ...
    this.registrationConfirmation = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const code = req.body.code;
        const result = yield this.authService.confirmUser(code);
        if (
          result.status === result_object_1.resultStatus.BAD_REQUEST ||
    ...
    this.registration = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield this.authService.registerUser(
          login,
          email,
          password,
        );
    ...
    this.registrationEmailResending = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    this.refreshToken = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield this.authService.updateToken(
          rf,
          ipAddr,
          userAgent,
        );
    ...
    this.newPassword = (req, res) =>
      __awaiter(this, void 0, void 0, function* () {
        const success = yield this.authService.confirmPasswordRecovery(
