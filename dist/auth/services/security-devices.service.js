...
let SecurityDevicesService = class SecurityDevicesService {
  ...
  getDevices(refreshToken) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const devices =
        yield this.securityDevicesRepository.findAllDevicesByUserId(decoded.id);
  ...
  deleteById(deviceId) {
    return __awaiter(this, void 0, void 0, function* () {
      const result =
        yield this.securityDevicesQueryRepository.geByDeviceId(deviceId);
      if (!result) {
        return {
  ...
  terminateAllSessionExcludeCurrent(refreshToken) {
    return __awaiter(this, void 0, void 0, function* () {
      const decoded = yield this.jwtAdapter.decodeToken(refreshToken);
      yield this.securityDevicesRepository.deleteAllDevicesExcludeCurrent(
        decoded.deviceId,
      );
    });
  }
