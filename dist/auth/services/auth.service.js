...
let AuthService = class AuthService {
  ...
  login(loginOrEmail, password, ipAddr, userAgent) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const passwordCorrect = yield this.bcryptAdapter.checkPassword(
        password,
        user.passwordHash,
      );
      if (!passwordCorrect) {
      ...
      const accessToken = yield this.jwtAdapter.signAccessToken(
        user._id.toString(),
      );
      const deviceId = (0, uuid_1.v4)();
      const refreshToken = yield this.jwtAdapter.signRefreshToken(
        user._id.toString(),
        ipAddr,
        userAgent,
        deviceId,
      ...
      const {
        ...
        iat: payloadIat,
        exp: payloadExp,
      } = yield this.jwtAdapter.parseJwtPayloadIat(refreshToken);
  ...
  registerUser(login, email, password) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (newUser.emailConfirmation) {
        try {
          yield this.emailAdapter.nodemailer(
            email,
            email_template_1.emailTemplate.registrationEmail(
  ...
  resendCode(email) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.usersRepository.findBYEmailAndRefreshCode(
        email,
        codeRefreshed,
      );
      try {
        yield this.emailAdapter.nodemailer(
          email,
          email_template_1.emailTemplate.registrationEmail(codeRefreshed),
        );
      } catch (err) {
        console.log("send email error");
      }
  ...
  updateToken(rf, ipAddr, userAgent) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const oldDevice =
        yield this.securityDevicesQueryRepository.findByIdAndIat(
          decoded.deviceId,
          decoded.iat,
        );
      if (!oldDevice) {
  ...
  expireToken(rftoken) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const { count } = yield this.securityDevicesRepository.deleteDevice(
        decoded.deviceId,
      );
      if (count === 0) {
        return {
  ...
  passwordRecovery(email) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (checkEmail) {
        try {
          yield this.emailAdapterYandex.nodemailer(
            email,
            email_template_1.emailTemplate.recoveryPasswordEmail(recovery_code),
          );
        } catch (err) {
  ...
  confirmPasswordRecovery(newPassword, recoveryCode) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      yield this.usersRepository.updatePasswordByRecoveryCode(
        recoveryCode,
        hashedPassword,
      );
      return true;
...
exports.AuthService = AuthService = __decorate(
  [
    ...
    __param(
      2,
      (0, inversify_1.inject)(email_adapter_1.EmailAdapterRecoveryPassword),
    ),
