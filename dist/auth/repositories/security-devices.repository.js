...
let SecurityDevicesRepository = class SecurityDevicesRepository {
  findAllDevices() {
    return __awaiter(this, void 0, void 0, function* () {
      return yield (0, mongo_db_1.getSecurityDeviceCollection)()
        .find()
        .toArray();
    });
  }
  ...
  updateDevice(deviceId, updatedDbDto) {
    return __awaiter(this, void 0, void 0, function* () {
      yield (0, mongo_db_1.getSecurityDeviceCollection)().updateOne(
        { deviceId: deviceId },
        { $set: updatedDbDto },
      );
    });
  ...
  deleteDevice(deviceId) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      mongo_db_1.getSecurityDeviceCollection)().deleteOne({ deviceId });
      return {
        count: (_a = result.deletedCount) !== null && _a !== void 0 ? _a : 0,
      };
    });
  }
  deleteAllDevices() {
