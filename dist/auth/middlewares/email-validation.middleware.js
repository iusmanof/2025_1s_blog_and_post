...
exports.loginValidationRegistration = exports.emailValidationRegistration =
  void 0;
...
exports.emailValidationRegistration = (0, express_validator_1.body)("email")
  ...
  .custom((email) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const user =
        yield users_repository_1.usersRepository.findByLoginOrEmail(email);
      if (user) {
...
exports.loginValidationRegistration = (0, express_validator_1.body)("login")
  ...
  .custom((login) =>
    __awaiter(void 0, void 0, void 0, function* () {
      const user =
        yield users_repository_1.usersRepository.findByLoginOrEmail(login);
      if (user) {
