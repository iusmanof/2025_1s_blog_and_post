...
const securityDeviceController = composition_root_1.container.get(
  security_devices_controller_1.SecurityDeviceController,
);
exports.securityDevicesRouter = (0, express_1.Router)();
exports.securityDevicesRouter.get(
  "/",
  refresh_token_middleware_1.verifyRefreshToken,
  securityDeviceController.getAllDevices,
);
exports.securityDevicesRouter.delete(
  "/",
  refresh_token_middleware_1.verifyRefreshToken,
...
exports.securityDevicesRouter.delete(
  "/:deviceId",
  refresh_token_middleware_1.verifyRefreshToken,
  user_id_belongs_to_another_middleware_1.userIdBelongsToAnotherMiddleware,
