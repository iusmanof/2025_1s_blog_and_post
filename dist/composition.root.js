...
const email_adapter_1 = require("./auth/application/adapters/email.adapter");
const jwt_adapter_1 = require("./auth/application/adapters/jwt.adapter");
const auth_repository_1 = require("./auth/infrastructure/auth.repository");
const security_devices_query_repository_1 = require("./auth/infrastructure/security-devices.query-repository");
const security_devices_repository_1 = require("./auth/infrastructure/security-devices.repository");
...
const comment_controller_1 = require("./comments/presentation/comment.controller");
